...
## P0 — Plan
- [x] T-00 Scaffold + SPEC/PLAN/TASKS + `active_feature.json` → F-007

## P1 — The commit tool
- [x] T-01 [US1,US2,US3] `scripts/git/compose.py` (compose + self-validate reusing
...
- [x] T-02 [US1,US4] Enrich `agents/committer.md` to commit via `aspis commit`; add the
...
## P3 — Tests
- [x] T-03 Tests: compose validity (task / span / scopeless), `Tasks:` trailer,
  attribution rejection, explicit-path commit in a temp repo, no-paths refusal
  (`tests/test_commit.py`)

## P4 — The why + docs
- [x] T-04 D-011 + ARCHITECTURE git section + ROADMAP Phase 3.6 done
