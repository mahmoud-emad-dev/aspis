...
## P0 — Plan
- [x] T-00 Scaffold + SPEC/PLAN/TASKS + `active_feature.json` → F-008

## P1 — Fix the two F-007 findings
- [x] T-01 [US3] Attribution blocklist → phrase/context-aware (allow `.claude`/`.opencode`
...
## P2 — CI
- [x] T-02 [US1] `.github/workflows/gate.yml` — ruff + pytest on Windows + Linux matrix
  (`.github/workflows/gate.yml`)

## P3 — Docs
- [x] T-03 [US2] Fix README (`.aspis`, real CLI); add `docs/QUICKSTART.md`
  (`README.md`, `docs/QUICKSTART.md`)

## P4 — Worked example + merge
- [x] T-04 [US4] A small worked example + `docs/FIRST-BUILD.md`; D-012; gate; merge to main
